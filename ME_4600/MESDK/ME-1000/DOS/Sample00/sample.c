...
////////
                    ...
                    read_configuration_word(bus_number,
                                             ...
                                             0x1e,
                                             &word_read2);
                    fprintf(pFile, "BASE4:  %04x%04x\n", word_read2,word_read1);
                    fprintf(stdout, "BASE4:  %04x%04x\n", word_read2,word_read1);
                    ...
                    read_configuration_word(bus_number,
                                             ...
                                             0x22,
                                             &word_read2);
                    fprintf(pFile, "BASE5:  %04x%04x\n", word_read2,word_read1);
                    fprintf(stdout, "BASE5:  %04x%04x\n", word_read2,word_read1);
                    ...
                    read_configuration_word(bus_number,
                                             ...
                                             0x26,
                                             &word_read2);
                    fprintf(pFile, "BASE6:  %04x%04x\n", word_read2,word_read1);
                    fprintf(stdout, "BASE6:  %04x%04x\n", word_read2,word_read1);
