...
/*------------------------------------------------------------                                              */
/*                  1.00    020321  ew     Asymetric divider                                                */
/*                                                                                                          */
/*----------------------------------------------------------------------------------------------------------*}
...
begin
  ...
  iCounterNo_2 := 2;
  CtrlWordA    := 15;
  {ME1400_TIMERINTERNCLOCK_10MHZ    =8
   ME1400_TIMERCLOCKSOURCE0_INTERN =4
   ME1400_TIMERCLOCKSOURCE1_OUT0   =2
   ME1400_TIMERCLOCKSOURCE2_OUT1   =1     }

  Writeln('Sample 31: Freqeuncy divider');
  Writeln('---------------------------');

  Writeln('Counter will be defined as a "Asymetrical divider"');
  Writeln('Timerclock is the internal 10MHz',#10);
   ...
   readln (ivalue_2);
   value := (10000000/(2*ivalue_0*ivalue_1*ivalue_2));
