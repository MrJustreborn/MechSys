...
Type DeviceInfoStruct
     dwBoardNumber      As Long     'Board number of Board
     dwVendorID         As Long     'PCI vendor ID
     dwDeviceID         As Long     'PCI device ID
     dwSystemSlotNumber As Long     'Slot number in PCI bus
     dwPortBase         As Long     'base port address
     dwPortCount        As Long     'Count of I/O addresses used
     dwIntChannel       As Long     'first Interrupt Channel
     dwPortBasePLX      As Long     'base port address
     dwPortCountPLX     As Long     'Count of I/O addresses used
     dwSerialNumber     As Long     'Serial number of the board
     dwBusNumber        As Long     'Bus number of the PCI bus (in most cases 0)
     dwHWRevision       As Long     'hardware revision of board
     dwIrqCnt           As Long     'number of interrupts
     dwVersion          As Long     'which board of the board family
End Type
...
'--------------------------------------------------------------------
' Shape
Global Const AO_RECTANGLE = &H0
Global Const AO_TRIANGLE = &H1
Global Const AO_SINUS = &H2
Global Const AO_COSINUS = &H3
Global Const AO_POS_RAMP = &H4
Global Const AO_NEG_RAMP = &H5


' Mode Polarity
Global Const AO6000_TRIGGER_TIMER = &H0
Global Const AO6000_TRIGGER_EXT_LOW = &H10
Global Const AO6000_TRIGGER_EXT_HIGH = &H20

' Channel
Global Const AO_CH00 = &H0
Global Const AO_CH01 = &H1
Global Const AO_CH02 = &H2
Global Const AO_CH03 = &H3
Global Const AO_CH04 = &H4
Global Const AO_CH05 = &H5
Global Const AO_CH06 = &H6
Global Const AO_CH07 = &H7
Global Const AO_CH08 = &H8
Global Const AO_CH09 = &H9
Global Const AO_CH10 = &HA
Global Const AO_CH11 = &HB
Global Const AO_CH12 = &HC
Global Const AO_CH13 = &HD
Global Const AO_CH14 = &HE
Global Const AO_CH15 = &HF

' Infinite
Global Const AO6000_INFINITE = &HFFFFFFFF
