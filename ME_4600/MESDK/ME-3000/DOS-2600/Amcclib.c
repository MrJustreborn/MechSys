...
//
// 9/9/97  MSD
//		Fixed incorrect use of registers in outsb, outsw and outsd.
//		Added comments explaining use of operand-size override prefix (0x66).
//		Added References comment.
//		Removed generate_special_cycle. Special cycle applications are extremely
//			rare (non-existant?).  Special cycles are not supported by 59xx chips.
//
...
//
//		[2] "Pentium Pro Family Developer's Manual - Volume 2: Programmer's Reference Manual",
//				Intel Corporation, Order Number 000901-001, or similar recent x86
