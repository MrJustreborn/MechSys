...
begin
  ...
  iErrorCode := me94DIGetBit (iBoardnumber, iBitNumber, iValue);
  ChkErrCode;
  sValue := IntToHex(iValue, 10);
  Writeln('Bit value: ', sValue);

   iErrorCode := me96DIGetBit (iBoardnumber, iBitNumber, iValue);
  ChkErrCode;
  sValue := IntToHex(iValue, 10);
  Writeln('Bit value: ', sValue);

  iErrorCode := me94DIGetByte (iBoardnumber,iPort, iValue);
  ChkErrCode;
  sValue := IntToHex(iValue, 10);
  Writeln('Byte value: ', sValue);

  iErrorCode := me96DIGetByte (iBoardnumber, iPort,iValue);
  ChkErrCode;
  sValue := IntToHex(iValue, 10);
  Writeln('Byte value: ', sValue);
  ...
  iErrorCode := me96DOSetBit (iBoardnumber,  iBitNumber, iValue );
  ChkErrCode;
  ...
  iErrorCode := me96DOSetByte (iBoardnumber, iPort, iValue);
  ChkErrCode;
