...
#define BUFFER_SIZE (64*1024)   // must be less or equal 64 K
...
int main(void)
{
    printf("Continuous at 1 channels external trigger\n");
    ...
    printf("-----------------------------------------------------------\n");
    {
        ...
        {
            double val = (sin( (double)(1024*i) / (double)BUFFER_SIZE * 2.0 * 3.14159) + 1.0) * (double)(VALUE_RANGE) / 2.0;
